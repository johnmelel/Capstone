"""
Strategy 2 - test.py
python3 -m src.parsers.strategy_2_clinical_qa.test | tee src/parsers/strategy_2_clinical_qa/output.txt
"""
...
from src.parsers.strategy_2_clinical_qa.post_processor import clean_and_chunk
...
def select_pdf() -> Path:
    """
    Prompt user to select a PDF file from data/strategy_2_clinical_qa/.
    
    Returns:
        Path to selected PDF
    """
    data_dir = Path("data/strategy_2_clinical_qa")
