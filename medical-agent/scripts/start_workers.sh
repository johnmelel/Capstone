...
cd "$(dirname "$0")/.."
python agents/structured_worker/main.py &
STRUCTURED_PID=$!
...
python agents/unstructured_worker/main.py &
UNSTRUCTURED_PID=$!
...
echo "  python scripts/query_system.py \"Get patients who took amphetamine in last 24 hours\""
echo ""
